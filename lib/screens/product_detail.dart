               ...
               child: Container(
                 child: ListTile(
                    leading: Padding(
                      ...
                      child: Text(this.widget.products.name.toUpperCase(), style: TextStyle(
                        color: Colors.black,
                        fontSize: 20.0,
                    ...
                    title: Padding(
                      ...
                      child: Row(children: <Widget>[
                        Expanded(
                            child: Text('₹${this.widget.products.price - this.widget.products.discount}',style: TextStyle(
                            color: Colors.redAccent,
                            fontSize: 20.0,
                            fontWeight: FontWeight.bold
                          ),),
                        ...
                        Expanded(
                            child: Text('₹${this.widget.products.price}', style: TextStyle(
                ...
                FlatButton(
                  ...
                  child:Row(
                    children: <Widget>[
                      ...
                      IconButton(icon: Icon(Icons.shopping_cart, color: Colors.redAccent,),
                       onPressed: (){
                  ...
                  IconButton(icon:Icon(Icons.favorite_border, color: Colors.redAccent,), onPressed: null)
               ],),
             ),
